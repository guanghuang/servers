...
The Filesystem and Sequential Thinking MCP servers now support SSE transport, enabling real-time, event-driven communication in addition to stdio.
- by default, it is sse mode
- environment `MCP_MODE=stdio` to enable mcp stdio
- default port 8080
